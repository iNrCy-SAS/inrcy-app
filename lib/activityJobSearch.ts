...
> = {
  ...
  economie_sociale_solidaire: {
    ...
    fintech_finance_solidaire_mutualiste: [
      "fintech mutualiste",
      ...
      "impact investing",
      "infrastructure mutualiste",
      "financement mutualiste du sport",
      "sport impact investing",
    ],
    ...
    esat_entreprise_adaptee: [
      "esat",
      "entreprise adaptée",
      "travail adapté",
      "handicap et emploi",
    ],
    mutuelle_protection_sociale: [
      "mutuelle",
      "mutualité",
      "protection sociale",
      "prévoyance solidaire",
    ],
    fondation_fonds_dotation: [
      "fondation",
      "fonds de dotation",
      "philanthropie",
      "mécénat d'intérêt général",
    ],
    ressourcerie_recyclerie: [
      "ressourcerie",
      "recyclerie",
      "réemploi solidaire",
      "économie circulaire",
    ],
    centre_social_tiers_lieu: [
      "centre social",
      "maison de quartier",
      "tiers-lieu solidaire",
      "médiation locale",
    ],
    ong_solidarite_internationale: [
      "ong",
      "humanitaire",
      "solidarité internationale",
      "aide au développement",
    ],
    reseau_accompagnement_ess: [
