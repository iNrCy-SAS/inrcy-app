...
export function buildVisioBookingConfirmationPayload(input: {
  ...
  const text = [
    ...
    "",
    "Pour profiter pleinement du rendez-vous :",
    "- Installez-vous de préférence sur un ordinateur.",
    "- Gardez à portée de main les identifiants de vos canaux existants (site, Google, Facebook, Instagram, LinkedIn…).",
    "- Vous saisirez vous-même vos accès : ne nous communiquez jamais vos mots de passe.",
    "",
  ...
  const calendarButton = calendarUrl
    ...
    : "";
  const preparationCard = `<table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" bgcolor="#0A1D3D" style="margin-top:18px;width:100%;background-color:#0A1D3D;border:1px solid #2F6E94;border-radius:14px"><tr><td width="48" valign="top" style="padding:17px 0 17px 18px;font-family:Arial,sans-serif;font-size:24px;line-height:28px">&#128187;</td><td style="padding:17px 18px 17px 8px"><p style="margin:0 0 7px;font-family:Arial,sans-serif;font-size:15px;font-weight:800;line-height:21px;color:#FFFFFF">Bien préparer votre rendez-vous</p><p style="margin:0;font-family:Arial,sans-serif;font-size:13px;line-height:20px;color:#D3DFF3">Installez-vous de préférence sur un ordinateur et gardez à portée de main les identifiants de vos canaux existants (site, Google, Facebook, Instagram, LinkedIn…).</p><p style="margin:7px 0 0;font-family:Arial,sans-serif;font-size:12px;line-height:18px;color:#79DEF8">Vous saisirez vous-même vos accès : ne nous communiquez jamais vos mots de passe.</p></td></tr></table>`;
  ...
  const htmlWithPreparation = html.replace(
    '<table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="margin:26px 0 14px">',
    `${preparationCard}<table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="margin:26px 0 14px">`,
  );
