...
const fr: DashboardCopy = {
  ...
  generatorSteps: {
    ...
    inr_search: { label: "Publier iNr'Search", shortLabel: "iNr'Search" },
...
const en: DashboardCopy = {
  ...
  hero: {
    ...
    generatorDesc: "A reflection of how effectively your communication channels perform.",
  ...
  generatorSteps: {
    ...
    inr_search: { label: "Publish iNr'Search", shortLabel: "iNr'Search" },
...
const es: DashboardCopy = {
  ...
  status: { connected: "Conectado", disconnected: "Desconectado", toConnect: "Conectar", toConfigure: "Configurar", toUpdate: "Actualizar", reconnect: "Reconectar", disabled: "Desactivado", noSite: "Sin sitio", soon: "Pronto", premiumPlan: "🔒 Plan Premium", notSubscribed: "No contratado" },
};
...
const it: DashboardCopy = {
  ...
  status: { connected: "Connesso", disconnected: "Disconnesso", toConnect: "Da connettere", toConfigure: "Configura", toUpdate: "Aggiorna", reconnect: "Ricollega", disabled: "Disattivato", noSite: "Nessun sito", soon: "Presto", premiumPlan: "🔒 Piano Premium", notSubscribed: "Non sottoscritto" },
};
...
const de: DashboardCopy = {
  ...
  status: { connected: "Verbunden", disconnected: "Getrennt", toConnect: "Verbinden", toConfigure: "Einrichten", toUpdate: "Aktualisieren", reconnect: "Neu verbinden", disabled: "Aus", noSite: "Keine Site", soon: "Bald", premiumPlan: "🔒 Premium-Paket", notSubscribed: "Nicht gebucht" },
};
...
const nl: DashboardCopy = {
  ...
  status: { connected: "Verbonden", disconnected: "Losgekoppeld", toConnect: "Koppelen", toConfigure: "Instellen", toUpdate: "Bijwerken", reconnect: "Opnieuw koppelen", disabled: "Uit", noSite: "Geen site", soon: "Binnenkort", premiumPlan: "🔒 Premium-pakket", notSubscribed: "Niet afgesloten" },
};
...
const pt: DashboardCopy = {
  ...
  status: { connected: "Ligado", disconnected: "Desligado", toConnect: "Ligar", toConfigure: "Configurar", toUpdate: "Atualizar", reconnect: "Religar", disabled: "Desativado", noSite: "Sem site", soon: "Breve", premiumPlan: "🔒 Plano Premium", notSubscribed: "Não subscrito" },
};
