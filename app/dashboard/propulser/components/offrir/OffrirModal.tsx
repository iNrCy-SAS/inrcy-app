...
const WORKFLOW_ACTION = "promo";
const WORKFLOW_FOLDER = "propulsions";
const WORKFLOW_TRACK_TYPE = "promo_mail";
const WORKFLOW_ATTACHMENT_PREFIX = "propulser-offrir";

export default function OffrirModal({ styles, onClose, onDone = onClose, saveDraftActionRef, onDraftStatusChange }: { styles: typeof stylesDash; onClose: () => void | Promise<void>; onDone?: () => void | Promise<void>; saveDraftActionRef?: MutableRefObject<(() => Promise<void>) | null>; onDraftStatusChange?: (message: string) => void }) {
          ...
          <div style={{ ...sectionStyle, ...messageSectionStyle }}>
            ...
            {aiContentGenerated ? (
              <div style={{ display: "flex", justifyContent: "flex-end", marginTop: 10 }}>
                <AiContentReportButton surface="propulser:offrir" content={`${subject}\n${body}`} />
              </div>
            ) : null}
          </div>
