...
export default function FacebookPanel(props: any) {
  ...
  return (
    <div className={`${styles.facebookConfigPanel} ${socialStyles.journey} ${socialStyles.facebook}`}>
      <section className={`${socialStyles.stepCard} ${socialStyles.facebook}`}>
      ...
      <section className={`${socialStyles.stepCard} ${socialStyles.facebook}`}>
        ...
        <div className={socialStyles.choiceGrid}>
          ...
          {([
            ...
            return (
              <label key={mode} className={socialStyles.choiceCard}>
                <span className={socialStyles.choiceCopy}>
                  <strong>{i18nT(labelKey)}</strong>
                  <span>{i18nT(helpKey)}</span>
                </span>
                <input
