...
export default function LinkedinPanel(props: any) {
  ...
  return (
    <div className={`${socialStyles.journey} ${socialStyles.linkedin}`}>
      {!profileReady ? (
        <section className={`${socialStyles.stepCard} ${socialStyles.linkedin}`}>
          <div className={socialStyles.stepHeader}>
            ...
            <div className={socialStyles.stepCopy}>
              ...
              <div className={styles.blockSub}>
                {i18nT("la_connexion_linkedin_permet_l_analyse_cec215a5")}{" "}
              </div>
            </div>
          </div>
      ...
      {profileReady ? (
        <section className={`${socialStyles.stepCard} ${socialStyles.linkedin}`}>
          ...
          <div className={socialStyles.stepBody}>
            ...
            {hasCompanyPage ? (
              <label className={socialStyles.inlineChoice}>
                <input
                ...
                <span>{i18nT("autoriser_le_partage_auto_sur_mon_babf8408")}</span>
              </label>
            ) : null}
