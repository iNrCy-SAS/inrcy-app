...
const PREVIEW_BACKGROUNDS: Record<AppAppearanceTheme, string> = {
  ...
  midnight: "radial-gradient(circle at 12% 3%, rgba(45,212,191,.38), transparent 43%), radial-gradient(circle at 94% 10%, rgba(96,165,250,.31), transparent 45%), radial-gradient(circle at 54% 110%, rgba(192,132,252,.22), transparent 48%), linear-gradient(145deg, #0d2231, #050b16)",
  graphite: "radial-gradient(circle at 12% 3%, rgba(240,203,134,.40), transparent 43%), radial-gradient(circle at 94% 10%, rgba(251,113,133,.27), transparent 45%), radial-gradient(circle at 54% 110%, rgba(192,132,252,.18), transparent 48%), linear-gradient(145deg, #2b2823, #0e0d0c)",
  "soft-violet": "radial-gradient(circle at 12% 3%, rgba(192,132,252,.38), transparent 43%), radial-gradient(circle at 94% 10%, rgba(56,189,248,.25), transparent 45%), radial-gradient(circle at 54% 110%, rgba(244,114,182,.22), transparent 48%), linear-gradient(145deg, #281a35, #0d0914)",
  "pearl-light": "radial-gradient(circle at 10% 0%, rgba(255,255,255,.96), transparent 45%), radial-gradient(circle at 94% 10%, rgba(219,112,147,.27), transparent 47%), radial-gradient(circle at 52% 110%, rgba(139,92,246,.18), transparent 50%), linear-gradient(145deg, #f6f1ef, #ddd3d1)",
  "azure-light": "radial-gradient(circle at 10% 0%, rgba(255,255,255,.95), transparent 45%), radial-gradient(circle at 94% 10%, rgba(14,165,233,.29), transparent 47%), radial-gradient(circle at 52% 110%, rgba(99,102,241,.17), transparent 50%), linear-gradient(145deg, #f0f7fa, #cbdde6)",
};

const PREVIEW_ACCENTS: Record<AppAppearanceTheme, string> = {
  original: "linear-gradient(90deg, #38bdf8, #a78bfa, #f472b6)",
  midnight: "linear-gradient(90deg, #2dd4bf, #60a5fa, #c084fc, #fbbf24)",
  graphite: "linear-gradient(90deg, #f0cb86, #fb7185, #c084fc, #38bdf8)",
  "soft-violet": "linear-gradient(90deg, #c084fc, #38bdf8, #f472b6, #fbbf24)",
  "pearl-light": "linear-gradient(90deg, #db7093, #8b5cf6, #2d9f8f, #d9902b)",
  "azure-light": "linear-gradient(90deg, #0ea5e9, #6366f1, #14b8a6, #f97316)",
};

const PREVIEW_GLOWS: Record<AppAppearanceTheme, string> = {
  original: "rgba(139,92,246,.24)",
  midnight: "rgba(45,212,191,.18)",
  graphite: "rgba(240,203,134,.18)",
  "soft-violet": "rgba(192,132,252,.19)",
  "pearl-light": "rgba(219,112,147,.14)",
...
const PREVIEW_SURFACES: Record<AppAppearanceTheme, PreviewSurfaces> = {
  ...
  midnight: {
    cardA: "linear-gradient(145deg, rgba(14,39,52,.98), rgba(15,29,46,.97))",
    cardB: "linear-gradient(145deg, rgba(15,29,46,.98), rgba(29,24,48,.97))",
    borderA: "rgba(45,212,191,.42)",
    borderB: "rgba(96,165,250,.40)",
    frameHighlight: "rgba(255,255,255,.12)",
  },
  graphite: {
    cardA: "linear-gradient(145deg, rgba(43,40,37,.98), rgba(35,34,37,.97))",
    cardB: "linear-gradient(145deg, rgba(35,34,37,.98), rgba(44,31,39,.97))",
    borderA: "rgba(240,203,134,.42)",
    borderB: "rgba(251,113,133,.40)",
    frameHighlight: "rgba(255,255,255,.12)",
  },
  "soft-violet": {
    cardA: "linear-gradient(145deg, rgba(37,30,49,.98), rgba(29,29,45,.97))",
    cardB: "linear-gradient(145deg, rgba(29,29,45,.98), rgba(43,27,44,.97))",
    borderA: "rgba(192,132,252,.43)",
    borderB: "rgba(56,189,248,.40)",
    frameHighlight: "rgba(255,255,255,.12)",
  },
  "pearl-light": {
    cardA: "linear-gradient(145deg, rgba(51,42,60,.99), rgba(35,37,55,.98))",
    cardB: "linear-gradient(145deg, rgba(35,37,55,.99), rgba(51,34,49,.98))",
    borderA: "rgba(219,112,147,.48)",
    borderB: "rgba(139,92,246,.45)",
    frameHighlight: "rgba(255,255,255,.42)",
  },
  "azure-light": {
    cardA: "linear-gradient(145deg, rgba(17,48,68,.99), rgba(21,37,64,.98))",
    cardB: "linear-gradient(145deg, rgba(21,37,64,.99), rgba(42,30,68,.98))",
    borderA: "rgba(14,165,233,.48)",
