...
const WORKFLOW_KIND = "fideliser" as const;
const WORKFLOW_ACTION = "inform";
const WORKFLOW_FOLDER = "informations";
const WORKFLOW_TRACK_TYPE = "newsletter_mail";
const WORKFLOW_ATTACHMENT_PREFIX = "fideliser-informer";

export default function InformerModal({
  styles,
  onClose,
  onDone = onClose,
  saveDraftActionRef,
    ...
    <div style={{ display: "flex", flexDirection: "column", height: "100%", minHeight: 0, minWidth: 0 }}>
      <div className={styles.blockCard} style={{ flex: 1, display: "flex", flexDirection: "column", minHeight: 0, minWidth: 0, maxWidth: "100%", boxSizing: "border-box", height: "100%" }}>
        <div className={styles.campaignTemplateIntro} style={{ display: isMobile ? "none" : undefined }}>
          <div className={styles.blockTitle}>{i18nT("modele_d_email_informer_2f1ef44a")}</div>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 10, flex: 1, minHeight: 0, overflow: "hidden" }}>
          ...
          <div style={{ ...sectionStyle, ...messageSectionStyle }}>
            ...
            {aiContentGenerated ? (
              <div style={{ display: "flex", justifyContent: "flex-end", marginTop: 10 }}>
                <AiContentReportButton surface="fideliser:informer" content={`${subject}\n${body}`} />
              </div>
            ) : null}
          </div>
          ...
          <div style={{ ...footerStyle, ...(isMobile ? { alignItems: "stretch", flexDirection: "column" as const } : {}) }}>
            <div style={{ display: "flex", flexDirection: "column", alignItems: "flex-start", gap: 5, minWidth: 0 }}>
              ...
              isMobile={isMobile}
              inputIdPrefix="informer-template-attachments"
              variant="footer"
              />
