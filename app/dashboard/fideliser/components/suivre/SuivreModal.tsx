...
const WORKFLOW_ACTION = "thanks";
const WORKFLOW_FOLDER = "suivis";
const WORKFLOW_TRACK_TYPE = "thanks_mail";
const WORKFLOW_ATTACHMENT_PREFIX = "fideliser-suivre";
    ...
    <div style={{ display: "flex", flexDirection: "column", height: "100%", minHeight: 0, minWidth: 0 }}>
      <div className={styles.blockCard} style={{ flex: 1, display: "flex", flexDirection: "column", minHeight: 0, minWidth: 0, maxWidth: "100%", boxSizing: "border-box", height: "100%" }}>
        <div className={styles.campaignTemplateIntro} style={{ display: isMobile ? "none" : undefined }}>
          <div className={styles.blockTitle}>{i18nT("modele_d_email_suivre_fbbadd0c")}</div>
          ...
          <div style={{ ...sectionStyle, ...messageSectionStyle }}>
            ...
            {aiContentGenerated ? (
              <div style={{ display: "flex", justifyContent: "flex-end", marginTop: 10 }}>
                <AiContentReportButton surface="fideliser:suivre" content={`${subject}\n${body}`} />
              </div>
            ) : null}
          </div>
