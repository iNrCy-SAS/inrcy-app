...
const optionalButRecommended = [
  ...
  "NEXT_PUBLIC_INRCY_PRICING_V2_CUTOVER_AT",
  ...
  "INRCY_VISIO_BOOKING_SECRET",
  "INRCY_VISIO_GOOGLE_REDIRECT_URI",
  "INRCY_VISIO_GOOGLE_ACCOUNT_EMAIL",
  "INRCY_VISIO_SHARED_CALENDAR_ID",
